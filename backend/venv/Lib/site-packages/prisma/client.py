...
SCHEMA_PATH = Path('C:/Users/defne/OneDrive/Belgeler/Decide/backend/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\defne\\.cache\\prisma-python\\binaries\\5.17.0\\393aa359c9ad4a4bb28630fb5613f9c281cde053\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    episode: 'actions.EpisodeActions[models.Episode]'
    episodenode: 'actions.EpisodeNodeActions[models.EpisodeNode]'
    decision: 'actions.DecisionActions[models.Decision]'
    ...
    def __init__(
        ...
        *,
        ...
        self.episode = actions.EpisodeActions[models.Episode](self, models.Episode)
        self.episodenode = actions.EpisodeNodeActions[models.EpisodeNode](self, models.EpisodeNode)
        self.decision = actions.DecisionActions[models.Decision](self, models.Decision)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'C:/Users/defne/OneDrive/Belgeler/Decide/backend/prisma/schema.prisma',
        }
...
class Batch:
    episode: 'EpisodeBatchActions'
    episodenode: 'EpisodeNodeBatchActions'
    decision: 'DecisionBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.episode = EpisodeBatchActions(self)
        self.episodenode = EpisodeNodeBatchActions(self)
        self.decision = DecisionBatchActions(self)
